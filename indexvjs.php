...
<div class="vjs--container content">
	...
	<div class="overlayhint overlayhint--intro" id="overlayhint">
		Klik op een tekstballon om een video af te spelen
	</div>
	<div class="overlayback overlayback--intro" id="overlayback" onClick="window.location='https://www.odijmond.nl/over-ons/maak-kennis/';">
		<< Terug naar website
	</div>
</div>
